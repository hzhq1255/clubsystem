<template>
  <div>
	  <el-col :span="6"  ::offset="1" style="padding-top: 10px;">
	  	<el-card :body-style="{ padding: '5px' }" style="height: 200px;" v-model="user" >
	  		<el-container>
				<el-aside width="180px" height="200px">
					<img src="../../../assets/img/img.jpg" class="user-avator" alt />
				</el-aside>
	  		<div class="club-info" align="center" >
		...
		<el-col :span="15"  :offset="1" style="padding-top: 10px;">
	...
	methods:{
		getData(){
			...
			this.$axios.get(url_news).then(news_response=>{
				var list = new Array();
				for(var i in news_response.data){
					if(news_response.data[i].club === null){
						list.push(news_response.data[i]);
					}
				}
				this.news = list;
			})
